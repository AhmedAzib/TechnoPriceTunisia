...
try:
    url = "https://www.mytek.tn/informatique/tablettes-tactiles/tablettes-android.html"
    print(f"Loading {url}...")
    driver.get(url)
    time.sleep(5)
    
    with open("mytek_tablet_v2.html", "w", encoding="utf-8") as f:
        f.write(driver.page_source)
    print("Saved mytek_tablet_v2.html")
