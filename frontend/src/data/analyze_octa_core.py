...
print("Simulating CPU Classification to find 'Octa Core'...")
...
for file_path in files:
    try:
        ...
        for p in data:
            ...
            # --- SIMULATE JS LOGIC (Simplified but mostly matching MobilesPage.jsx) ---
            ...
            # 3. Forced Mappings (Honor, Itel, Realme, Lesia)
            ...
            # 6. Keyword Inference (if Unknown/Others/Octa Core)
            ...
            if cpu == "Octa Core":
                octa_core_titles.append(title)

    except Exception as e:
        pass

print(f"Total 'Octa Core' found: {len(octa_core_titles)}")

print("\n--- EXACT TITLES ---")
for t in octa_core_titles:
    print(t)
